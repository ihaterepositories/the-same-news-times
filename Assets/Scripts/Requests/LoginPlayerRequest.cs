...
namespace Requests
{
    public static class LoginPlayerRequest
    {
        public static IEnumerator PostRequestCoroutine(PlayerLoginData playerLoginData, System.Action<StatusCode, string> callback)
        {
